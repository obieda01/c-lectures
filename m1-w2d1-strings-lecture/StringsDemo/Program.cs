...
namespace StringsDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            length = longSentence.Length;
            Console.WriteLine("Length of Long Sentence " + length);
            ...
            char secondCharacter = shortSentence[1];
            Console.WriteLine("Second character is " + secondCharacter);

            char lastCharacter = shortSentence[shortSentence.Length - 1];
            ...
            Console.WriteLine("Short sentance 2nd through 5th characters --> " + substring);

            substring = longSentence.Substring(1, 4);
            Console.WriteLine("Long sentance 2nd through 5th characters --> " + substring);
